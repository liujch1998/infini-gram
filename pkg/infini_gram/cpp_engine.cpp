...
PYBIND11_MODULE(cpp_engine, m) {
    ...
    py::class_<Engine>(m, "Engine")
        ...
        .def("get_docs_by_ranks_2", &Engine::get_docs_by_ranks_2, py::call_guard<py::gil_scoped_release>(), "list_of_s_and_rank"_a, "needle_len"_a, "max_ctx_len"_a)
        ...
        .def("get_docs_by_ptrs_2", &Engine::get_docs_by_ptrs_2, py::call_guard<py::gil_scoped_release>(), "list_of_s_and_ptr"_a, "needle_len"_a, "max_ctx_len"_a)
