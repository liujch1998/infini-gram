...
PYBIND11_MODULE(cpp_engine, m) {
    ...
    py::class_<Engine>(m, "Engine")
        ...
        .def("get_doc_by_rank", &Engine::get_doc_by_rank, "s"_a, "rank"_a, "max_disp_len"_a, "len_as_ctx"_a)
        .def("get_docs_by_ranks", &Engine::get_docs_by_ranks, "list_of_s_and_rank"_a, "max_disp_len"_a, "len_as_ctx"_a)
        .def("get_doc_by_ptr", &Engine::get_doc_by_ptr, "s"_a, "ptr"_a, "max_disp_len"_a, "len_as_ctx"_a)
        .def("get_docs_by_ptrs", &Engine::get_docs_by_ptrs, "list_of_s_and_ptr"_a, "max_disp_len"_a, "len_as_ctx"_a)
